<?php
ob_start();
define('API_KEY','280612859:AAEj0WkOn3OkRGSe5CEEamOHQiw9FEviRYs');
$admin = "277617346,70980478";
...
".$jsu;
  ...
  $text = "به ربات ادیت نکن\nخوش آمدید\nبرای اضافه کردنم تو گروه رو لینک زیر کلیک کن//telegram.me/DontEdit_BOT?startgroup=new";
  bot('sendmessage',[
    'chat_id'=>$chat_id,
    'text'=>$text,
    'parse_mode'=>'html',
    'reply_markup'=>json_encode([
      'inline_keyboard'=>[
        [
          ['text'=>'Fuck Everything','url'=>'https://telegram.me/ImUnknow']
          ['text'=>'AmirHossein','url'=>'https://telegram.me/Amiroo_2016_bot']
        ],
        [
          ['text'=>'CreateBOT','url'=>'https://telegram.me/bot2016channel']
        ]
      ]
    ])
  ]);
